...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" version="3.4.12-Madeira" hasScaleBasedVisibilityFlag="0" maxScale="0">
  <flags>
  ...
  <pipe>
    <rasterrenderer band="1" alphaBand="-1" type="paletted" opacity="1">
      ...
      <colorPalette>
        <paletteEntry color="#0d0887" alpha="255" value="1" label="RWS (MNDW &amp; MGRN)"/>
        <paletteEntry color="#cb4778" alpha="255" value="2" label="MNWS"/>
        <paletteEntry color="#f0f921" alpha="255" value="3" label="MNWS + RWS"/>
      </colorPalette>
    ...
    <huesaturation colorizeOn="0" colorizeBlue="128" grayscaleMode="0" saturation="0" colorizeRed="255" colorizeGreen="128" colorizeStrength="100"/>
